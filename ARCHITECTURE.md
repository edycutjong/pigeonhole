...
| Tests | 12 Foundry (incl. fuzz + I1/I3) + 25 vitest (predict vs on-chain, reducer, decimals, `eth_getLogs` chunking/dedupe/overlap/race, 4 fast-check properties × 5,000 cases) + 34 Playwright E2E checks |
